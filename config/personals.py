...
# Your legal name
first_name = "Krissy"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Anne"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Waters"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "5097236466"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Spokane Valley"                  # Los Angeles, San Francisco, etc.
'''
